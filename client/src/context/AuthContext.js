...
export function AuthProvider({ children }) {
    ...
    const login = async (email, password) => {
        try {
            ...
            // ✅ FIX: employee ko as-is rakho — User._id ko kabhi fallback mat banao
            // Agar employee null hai to null hi rehne do; getEmployeeId() ise sahi
            // se handle karega aur galat ID kabhi enroll API ko nahi jayegi
            const userData = {
                ...restUserData,
