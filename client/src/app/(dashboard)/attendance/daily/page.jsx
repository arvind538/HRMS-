          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 md:pb-0">
            {['All', 'Present', 'Late', 'Absent', 'Half Day'].map((filter) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition whitespace-nowrap cursor-pointer ${statusFilter === filter ? 'bg-indigo-600 text-white shadow-sm' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                  }`}
              >
                {filter}
              </button>
                      ...
                      <td className="px-5 py-3.5 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="p-2 bg-slate-100 hover:bg-indigo-600 hover:text-white text-slate-600 rounded-xl transition shadow-xs cursor-pointer"
                            title="Change Status"
                          >
            ...
            <form onSubmit={handleUpdateStatus} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-5 py-2.5 border border-slate-200 text-slate-600 rounded-xl text-xs font-semibold hover:bg-slate-50 transition active:scale-95 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-semibold shadow-md shadow-indigo-100 transition active:scale-95 disabled:opacity-50 flex items-center gap-2 cursor-pointer"
                >
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full p-6 space-y-5 transform scale-100 animate-in zoom-in-95 duration-200 border border-slate-100 text-center">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="flex-1 px-4 py-2.5 border border-slate-200 text-slate-600 rounded-xl text-xs font-semibold hover:bg-slate-50 transition cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-semibold shadow-md shadow-rose-100 transition active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer"
              >
