            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 sm:p-7 rounded-2xl sm:rounded-3xl border border-slate-200/80 shadow-xs">
                ...
                <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="p-2.5 rounded-xl sm:rounded-2xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-700 hover:text-indigo-600 transition-all shadow-2xs active:scale-95 disabled:opacity-50 cursor-pointer"
                    ...
                    <div className="flex items-center bg-slate-100/90 p-1 rounded-xl sm:rounded-2xl border border-slate-200/70 shadow-inner">
                        <button
                            type="button"
                            onClick={() => setViewMode("grid")}
                            className={`p-1.5 sm:p-2 rounded-lg sm:rounded-xl text-xs font-bold transition-all cursor-pointer ${viewMode === "grid"
                        ...
                        <button
                            ...
                            className={`p-1.5 sm:p-2 rounded-lg sm:rounded-xl text-xs font-bold transition-all cursor-pointer ${viewMode === "list"
                                ? "bg-white text-indigo-600 shadow-xs"
                                : "text-slate-500 hover:text-slate-900"
                                }`}
                            title="List View"
            ...
            {loading ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3.5 sm:gap-4 animate-pulse">
                    {[...Array(8)].map((_, i) => (
                        <div
                            key={i}
                            className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200/80 p-5 sm:p-6 space-y-4 shadow-xs"
                        >
                ...
                <div className="bg-white rounded-2xl sm:rounded-3xl border border-dashed border-slate-300 p-12 sm:p-16 text-center space-y-3 shadow-xs">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-slate-50 text-slate-400 flex items-center justify-center mx-auto border border-slate-200">
                    ...
                    {filteredEmployees.map((emp) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className="mt-4 pt-3.5 border-t border-slate-100 space-y-1.5"
                                ...
                                >
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => router.push(`/employees/profile?id=${empId}`)}
                                        className="w-full mt-2 py-2 text-xs font-bold text-indigo-700 bg-indigo-50/70 hover:bg-indigo-600 hover:text-white rounded-xl border border-indigo-200/60 transition-all flex items-center justify-center gap-1.5 shadow-2xs cursor-pointer active:scale-95"
                                    >
