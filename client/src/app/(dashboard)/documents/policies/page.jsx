...
import { Loader2, FileText, Trash2, FolderOpen, Edit3, ExternalLink, ShieldAlert, Clock, Home, Lock, CalendarDays, CheckCircle2 } from "lucide-react";
...
export default function HRPoliciesPage() {
  ...
  return (
    <div className="space-y-6 transition-all duration-300">
      ...
      {isAdmin && (
        <div>
          <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Quick Policy Templates</h3>
            ...
            >
              <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-slate-400 mt-1 truncate max-w-xl">{d.description || "Official company internal policy document."}</p>
                </div>
              </div>
